...
import { LoginTestData } from '../utils/types';

//Load JSON test data logindata.json

const jsonPath="testdata/logindata.json";
const jsonTestData: LoginTestData[] = DataProvider.getTestDataFromJson(jsonPath);
...
const csvTestData: LoginTestData[] = DataProvider.getTestDataFromCsv(csvPath);
