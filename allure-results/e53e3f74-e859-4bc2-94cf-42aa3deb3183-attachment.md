...
```
Error: locator.click: Error: strict mode violation: locator('a:has-text("Register")') resolved to 2 elements:
...
Call log:
  - waiting for locator('a:has-text("Register")')
...
```ts
  ...
  20 |         this.linkLogin = page.locator('#top-links a:has-text("Login")');
